...
import thumbnail14 from "./Asset/Screenshot (612).png"
import thumbnail15 from "./Asset/Screenshot (614).png"
    ...
    return(
        ...
        <div className="works">
            ...
            <div className="works-wrapper">
                ...
                <div className="thumb"> <a href="https://g-drive-clone.onrender.com"><div><img src={thumbnail14} alt="icon"/></div><div className="des">firebase-Storage</div></a></div>
            ...
            <div className="works-wrapper">
                ...
                <div className="thumb"><a href="https://jokesapp-6mwn.onrender.com"><div><img src={thumbnail15} alt="icon"/></div> <div className="des">Jokes-Generator</div></a></div>
            </div>
            </div>
        </div>
    )
